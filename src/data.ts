...
export const SKILLS = [
  ...
  { name: 'Power BI', phrase: 'Dashboards', iconUrl: 'https://upload.wikimedia.org/wikipedia/commons/c/cf/New_Power_BI_Logo.svg' },
  { name: 'Excel', phrase: 'Planilhas', iconUrl: 'https://upload.wikimedia.org/wikipedia/commons/3/34/Microsoft_Office_Excel_%282019%E2%80%93present%29.svg' }
];
